    ...
    private void SubmitAction(ActionEvent event) throws NoSuchAlgorithmException, SQLException
    {
       ...
       {           
        ...
        else
        {
           ...
           String newTable="Create Table "+suser+"(course Varchar(4), courseNum Varchar(4), courseName Varchar(200), credit int, grade VARCHAR(3), stat VARCHAR(30), Semester VARCHAR(30));";
